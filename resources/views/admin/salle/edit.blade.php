     ...
     <div class="w-full max-w-sm min-w-[200px]"> 
            ...
            <div class="relative">
                <select
                    ...
                    <option {{ old("type",$salle->type) == "SM" ? 'selected':'' }} value="SM">Salle Multimedia</option>
                    <option {{ old("type",$salle->type) == "SC" ? 'selected':'' }} value="SC">salle de cours</option>
                </select>
        ...
        <x-text-input id="capacite" name="capacite" type="number"
            class="mt-1 block w-full"
