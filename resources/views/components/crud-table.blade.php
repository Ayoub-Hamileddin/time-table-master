...
<div class="mx-5 mt-5">
    ...
    <div class="relative flex flex-col w-[1100px] mx-auto h-auto overflow-scroll text-gray-700 bg-white shadow-md rounded-lg bg-clip-border">
        ...
        @foreach ($filieres as $filiere )
            <tr class="hover:bg-slate-50 border-b border-slate-200">
              ...
              <td class="p-4 py-5">
                <p class="block text-sm text-slate-800">{{ $filiere->anne }}</p>
              </td>
